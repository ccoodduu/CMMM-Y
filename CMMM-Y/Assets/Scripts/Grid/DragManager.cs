...
public class DragManager : MonoBehaviour
{
    ...
    public void EndDrag() {
        ...
        ActionManager.instance.DoAction(new DragCell(new Vector2Int((int)selectedCell.position.x, (int)selectedCell.position.y), new Vector2Int((int)mousePos.x, (int)mousePos.y)));
